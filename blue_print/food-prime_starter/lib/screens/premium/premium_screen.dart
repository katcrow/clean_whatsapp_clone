...
class PremiumScreen extends StatelessWidget {
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            _singlePremiumItemWidget(
                title: "Enjoy zero delivery fees and reduced\nservice fees on order \$12.",
                icon: const Icon(
                  Icons.shopping_cart,
                  color: primaryColorED6E1B,
                  size: 30,
            ...
            const SizedBox(height: 20),
            _singlePremiumItemWidget(
                title: "Free 1 month trial, \$9.99 monthly\nafter, easily cancel anything.",
                icon: const Icon(
            ...
            RichText(
              ...
              text: const TextSpan(text: "By tapping the button, I agree to the ", style: TextStyle(color: Colors.black), children: [
                TextSpan(text: "Teams", style: TextStyle(color: primaryColorED6E1B)),
  ...
  //
  Widget _singlePremiumItemWidget({required String title, required Icon icon}) {
    return Row(
      children: [
        icon,
