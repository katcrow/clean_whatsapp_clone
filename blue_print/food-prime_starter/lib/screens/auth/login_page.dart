...
import 'package:food_prime_app/screens/widgets/form_container_widget.dart';
...
class _LoginPageState extends State<LoginPage> {
  late bool _rememberMeCheckValue;

  @override
  void initState() {
    _rememberMeCheckValue = false;
    super.initState();
  }
              ...
              child: Column(
                ...
                children: [
                      ...
                      Row(
                        children: [
                          Checkbox(
                            ...
                            onChanged: (value) {
                              setState(() => _rememberMeCheckValue = value!);
                            },
                          ),
                  ...
                  ButtonContainerWidget(
                    title: 'Log In',
                    onTap: () =>
                        Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => const PremiumScreen()), (route) => false),
                  ),
                  const SizedBox(height: 20),
                  Row(
                    children: [
                  ...
                  Row(
                    ...
                    children: [
                      _optionSignIn(iconData: FontAwesomeIcons.google, color: redColor),
                      _optionSignIn(iconData: FontAwesomeIcons.facebook, color: Colors.blue[900]!),
                      _optionSignIn(iconData: FontAwesomeIcons.linkedin, color: Colors.blue[600]!),
                    ],
                  ),
                ],
              ),
  ...
  Widget _optionSignIn({required IconData iconData, required Color color}) {
    return Container(
      ...
      child: Center(
        child: Icon(iconData, color: whiteColor, size: 30),
      ),
    );
  }
}
